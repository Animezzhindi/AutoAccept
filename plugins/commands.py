    ...
    await m.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [[
                ...
                InlineKeyboardButton("• ᴜᴩᴅᴀᴛᴇꜱ •", url="https://telegram.me/zoroflix"),
            ]]
        )
    )
...
async def approve_new(client, m):
    ...
    try:
        ...
        try:
            await client.send_message(m.from_user.id, """<b>👋🏻 𝖧𝖾𝗅𝗅𝗈 {}, 𝖶𝖾𝗅𝖼𝗈𝗆𝖾 𝗍𝗈 𝖹𝖮𝖱𝖮𝖥𝖫𝖨𝖷 \n𝖸𝗈𝗎𝗋 𝗋𝖾𝗊𝗎𝖾𝗌𝗍 {} 𝗁𝖺𝗌 𝖻𝖾𝖾𝗇 𝖺𝖼𝖼𝖾𝗉𝗍𝖾𝖽. \n\n𝖩𝗈𝗂𝗇 𝗈𝗎𝗋 𝖼𝗁𝖺𝗇𝗇𝖾𝗅 𝖿𝗈𝗋 𝗇𝖾𝗐 𝗋𝖾𝗅𝖾𝗌𝖾𝖽 𝖺𝗇𝗂𝗆𝖾, 𝖾𝗑𝖼𝗅𝗎𝗌𝗂𝗏𝖾 𝗆𝗈𝗏𝗂𝖾𝗌, 𝖺𝖽𝗎𝗅𝗍 𝗅𝖾𝖺𝗄 𝖼𝗈𝗅𝗅𝖾𝖼𝗍𝗂𝗈𝗇𝗌. \n\n››  𝗃𝗈𝗂𝗇 𝗈𝗎𝗋 𝖼𝗈𝗆𝗆𝗎𝗇𝗂𝗍𝗒  @ZOROFLIX \n\n𝖢𝗅𝗂𝖼𝗄 𝗁𝖾𝗋𝖾 𝗍𝗈 𝗃𝗈𝗂𝗇 𝖼𝗁𝖺𝗇𝗇𝖾𝗅 𝗃𝗈𝗂𝗇 𝗇𝗈𝗐.</b>""".format(m.from_user.mention, m.chat.title))
        except:
            pass
    except Exception as e:
        print(str(e))
